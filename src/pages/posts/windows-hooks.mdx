...
There are ways to inject **dlls** in single processes, they can be a little bit tricky, I may do a different post on that since I've had to deal with that this issue before.
