...
> **Note:** There are more layouts than this, one example is the [ETI 660](https://www.emma02.hobby-site.com/eti.html) where programs started at offset 0x600.
...
You can look at [this pdf](https://www.cs.columbia.edu/~sedwards/classes/2016/4840-spring/designs/Chip8.pdf) to get a sense of how they mapped the characters to the respective bit representations, it's pretty fun!
...
We'll be using **Rust** (I think that was obvious) for this. To draw things on the screen we'll use **SDL**, more specifically the [sdl2](https://docs.rs/sdl2/latest/sdl2/) crate, which contains all the bindings we need for it. It "should" run the same in Windows, Linux, MacOS, provided you have the [**SDL** libraries](https://wiki.libsdl.org/SDL2/Installation) installed. I've done it under linux and also tested it on MacOS.
...
I won't give you the code for all the instructions, in fact, I think it's a good exercise to do them yourself, but if you want them as a reference, [check the repo](https://github.com/rezzmk/rust-Chip-8/blob/main/src/Chip-8.rs).
...
This is it! You can now look for ROM files to run. I like [this github repo](https://github.com/kripod/Chip8-roms).
...
- [Thomas P. Greene's Cowgod's Chip-8 Technical Reference](http://devernay.free.fr/hacks/chip8/C8TECH10.HTM)
