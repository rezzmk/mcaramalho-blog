...
Allright, now comes the really fun and depressing part at the same time (\*insert Schrödinger joke here\*), the instructions. This is the make it or break it part of our emulator, because if we fail these, we'll get some pretty scuffed results.
