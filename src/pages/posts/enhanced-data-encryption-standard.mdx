...
Let me preface this whole post by saying this idea was developed purely for exploration purposes, in fact, this was a proposed project to a class of Applied Cryptography that I'm attending in a Cybersecurity Master's, so it's mostly academic, without the rigor part. It does, however, show that some tweaks here and there can make a difference, in this case, in terms of **performance and security** which is pretty much what we want in encryption algorithms.
