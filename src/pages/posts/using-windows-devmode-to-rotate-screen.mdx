...
title: Rotating screen layout with DEVMODE P/Invokes
publishDate: 12/4/2022
description: How to rotate your screen's layout with code, using Windows DEVMODE and some P/Invokes
categories: ["windows", "devmode", "pinvoke", "screen", "configuration", "tutorials", "C#"]
tags: ["windows", "devmode", "pinvoke", "screen", "configuration", "tutorials", "C#"]
---
